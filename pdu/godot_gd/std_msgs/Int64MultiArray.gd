class_name HakoPdu_std_msgs_Int64MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_Int64MultiArray:
    var obj := HakoPdu_std_msgs_Int64MultiArray.new()
    if d.has("layout"):
