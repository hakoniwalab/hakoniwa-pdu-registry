...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneGetStateRequestPacket
    {
        ...
        public DroneGetStateRequest body { get; set; } = new DroneGetStateRequest();
        ...
        public static DroneGetStateRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new DroneGetStateRequestPacket();
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneGetStateRequest>(bodyValue, item => DroneGetStateRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneGetStateRequestPacket FromJson(string json)
        {
