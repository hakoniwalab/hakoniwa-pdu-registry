defmodule HakoPdu.Ev3Msgs.Ev3PduActuatorHeaderConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_ev3_pdu_actuator_header(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.Ev3Msgs.Ev3PduActuatorHeader.new()
    binary_read_recursive_ev3_pdu_actuator_header(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_ev3_pdu_actuator_header(obj) do
    {base_data, heap_data} = binary_write_recursive_ev3_pdu_actuator_header(0, "", "", obj)
  ...
  def binary_read_recursive_ev3_pdu_actuator_header(meta, binary_data, obj, base_off) do
    ...
    # member: asset_time, type: int64 (primitive), offset: 136, size: 8
    asset_time = read_primitive("int64", binary_part(binary_data, base_off + 136, 8))
  ...
  def binary_write_recursive_ev3_pdu_actuator_header(parent_off, heap_data, allocator, obj) do
    # member: name, type: string (primitive), offset: 0, size: 128
    ...
    # member: asset_time, type: int64 (primitive), offset: 136, size: 8
    allocator = add_binary(allocator, parent_off + 136, primitive_to_bin("int64", obj.asset_time, 8))
