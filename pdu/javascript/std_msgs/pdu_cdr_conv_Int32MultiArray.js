...
export class PduInt32MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { Int32MultiArray } src
     */
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new Int32MultiArray());
    }
}
