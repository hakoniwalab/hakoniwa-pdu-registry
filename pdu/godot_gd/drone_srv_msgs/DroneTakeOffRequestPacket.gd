...
var body: HakoPdu_drone_srv_msgs_DroneTakeOffRequest = HakoPdu_drone_srv_msgs_DroneTakeOffRequest.new()

static func from_dict(d: Dictionary) -> HakoPdu_drone_srv_msgs_DroneTakeOffRequestPacket:
    var obj := HakoPdu_drone_srv_msgs_DroneTakeOffRequestPacket.new()
    if d.has("header"):
