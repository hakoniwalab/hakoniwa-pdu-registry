...
namespace Hakoniwa.Pdu.CSharpV2.sensor_msgs
{
    public class MultiEchoLaserScan
    {
        ...
        public List<LaserEcho> ranges { get; set; } = new List<LaserEcho>();
        public List<LaserEcho> intensities { get; set; } = new List<LaserEcho>();
        ...
        public static MultiEchoLaserScan FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.ranges = PduRuntime.ConvertObjectList<LaserEcho>(rangesValue, item => LaserEcho.FromDictionary(item));
            }
            if (dict.TryGetValue("intensities", out var intensitiesValue))
            {
                obj.intensities = PduRuntime.ConvertObjectList<LaserEcho>(intensitiesValue, item => LaserEcho.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static MultiEchoLaserScan FromJson(string json)
        {
