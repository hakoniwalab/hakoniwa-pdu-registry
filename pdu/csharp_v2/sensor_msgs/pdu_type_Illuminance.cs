...
namespace Hakoniwa.Pdu.CSharpV2.sensor_msgs
{
    public class Illuminance
    {
        ...
        public Dictionary<string, object?> ToDictionary()
        {
            ...
            dict["illuminance"] = ToSerializableValue(illuminance);
            dict["variance"] = ToSerializableValue(variance);
            return dict;
        }

        public static Illuminance FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            if (dict.TryGetValue("illuminance", out var illuminanceValue))
            {
                obj.illuminance = PduRuntime.ConvertValue<double>(illuminanceValue);
            }
        ...
        public static Illuminance FromJson(string json)
        {
