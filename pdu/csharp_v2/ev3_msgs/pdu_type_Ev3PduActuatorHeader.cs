...
namespace Hakoniwa.Pdu.CSharpV2.ev3_msgs
{
    public class Ev3PduActuatorHeader
    {
        ...
        public long asset_time { get; set; } = 0;
        ...
        public static Ev3PduActuatorHeader FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.asset_time = PduRuntime.ConvertValue<long>(asset_timeValue);
            }
        ...
        public static Ev3PduActuatorHeader FromJson(string json)
        {
