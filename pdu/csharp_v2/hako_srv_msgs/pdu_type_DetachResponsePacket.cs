...
{
    public class DetachResponsePacket
    {
        public ServiceResponseHeader header { get; set; } = new ServiceResponseHeader();
        public DetachResponse body { get; set; } = new DetachResponse();
        ...
        public static DetachResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DetachResponse>(bodyValue, item => DetachResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DetachResponsePacket FromJson(string json)
        {
