defmodule HakoPdu.HakoMsgs.HakoCameraDataConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_hako_camera_data(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.HakoCameraData.new()
    binary_read_recursive_hako_camera_data(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_hako_camera_data(obj) do
    {base_data, heap_data} = binary_write_recursive_hako_camera_data(0, "", "", obj)
  ...
  def binary_read_recursive_hako_camera_data(meta, binary_data, obj, base_off) do
    ...
    # member: image, type: sensor_msgs/CompressedImage (struct), offset: 4, size: 272
    image =
  ...
  def binary_write_recursive_hako_camera_data(parent_off, heap_data, allocator, obj) do
    # member: request_id, type: int32 (primitive), offset: 0, size: 4
