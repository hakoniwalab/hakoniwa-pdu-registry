...
{
    public static class HakoDroneCmdTakeoffConverter
    {
        public static HakoDroneCmdTakeoff PduToMsg(byte[] binaryData)
        {
            var obj = new HakoDroneCmdTakeoff();
            var meta = PduMetaData.Parse(binaryData);
            BinaryReadRecursive(meta, binaryData, obj, PduMetaData.PduMetaDataSize);
            return obj;
        }

        public static byte[] MsgToPdu(HakoDroneCmdTakeoff obj)
        {
        ...
        public static void BinaryReadRecursive(PduMetaData meta, byte[] binaryData, HakoDroneCmdTakeoff obj, int baseOff)
        {
        ...
        public static void BinaryWriteRecursive(int parentOff, BinaryWriterContainer writer, DynamicAllocator allocator, HakoDroneCmdTakeoff obj)
        {
