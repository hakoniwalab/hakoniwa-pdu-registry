...
inline void binary_read_recursive_PointStamped(
...
inline godot::Dictionary pdu_to_godot_PointStamped(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_PointStamped(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_PointStamped(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("point")) {
        hako::godot_pdu::geometry_msgs::binary_write_recursive_Point(
            ...
            writer,
            allocator,
            hako::godot_runtime::variant_to_dictionary(obj["point"]));
    }
}

inline godot::PackedByteArray godot_to_pdu_PointStamped(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_PointStamped(0, writer, base_allocator, obj);
