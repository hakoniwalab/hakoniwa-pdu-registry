...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class Float32MultiArray
    {
        ...
        public static Float32MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<float>(dataValue);
            }
            return obj;
        }
        ...
        public static Float32MultiArray FromJson(string json)
        {
