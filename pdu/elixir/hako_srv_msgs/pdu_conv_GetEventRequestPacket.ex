defmodule HakoPdu.HakoSrvMsgs.GetEventRequestPacketConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_get_event_request_packet(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoSrvMsgs.GetEventRequestPacket.new()
    binary_read_recursive_get_event_request_packet(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_get_event_request_packet(obj) do
    {base_data, heap_data} = binary_write_recursive_get_event_request_packet(0, "", "", obj)
  ...
  def binary_read_recursive_get_event_request_packet(meta, binary_data, obj, base_off) do
    ...
    # member: body, type: GetEventRequest (struct), offset: 268, size: 128
    body =
      HakoPdu.HakoSrvMsgs.GetEventRequestConverter.binary_read_recursive_get_event_request(
        meta,
        binary_data,
        HakoPdu.HakoSrvMsgs.GetEventRequest.new(),
        base_off + 268
      )
  ...
  def binary_write_recursive_get_event_request_packet(parent_off, heap_data, allocator, obj) do
    # member: header, type: ServiceRequestHeader (struct), offset: 0, size: 268
    {allocator, heap_data} =
    ...
    # member: body, type: GetEventRequest (struct), offset: 268, size: 128
    {allocator, heap_data} =
      HakoPdu.HakoSrvMsgs.GetEventRequestConverter.binary_write_recursive_get_event_request(
        parent_off + 268,
        heap_data,
        allocator,
        obj.body
