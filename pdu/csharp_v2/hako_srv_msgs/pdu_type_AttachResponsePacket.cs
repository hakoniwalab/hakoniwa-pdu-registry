...
{
    public class AttachResponsePacket
    {
        public ServiceResponseHeader header { get; set; } = new ServiceResponseHeader();
        public AttachResponse body { get; set; } = new AttachResponse();
        ...
        public static AttachResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AttachResponse>(bodyValue, item => AttachResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AttachResponsePacket FromJson(string json)
        {
