...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneLandResponsePacket
    {
        ...
        public DroneLandResponse body { get; set; } = new DroneLandResponse();
        ...
        public static DroneLandResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneLandResponse>(bodyValue, item => DroneLandResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneLandResponsePacket FromJson(string json)
        {
