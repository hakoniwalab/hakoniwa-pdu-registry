defmodule HakoPdu.SensorMsgs.ImuConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_imu(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.SensorMsgs.Imu.new()
    binary_read_recursive_imu(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_imu(obj) do
    {base_data, heap_data} = binary_write_recursive_imu(0, "", "", obj)
  ...
  def binary_read_recursive_imu(meta, binary_data, obj, base_off) do
    ...
    orientation_covariance = read_primitive_array("float64", binary_part(binary_data, base_off + 168, 72), 9, div(72, 9))
    ...
    angular_velocity_covariance = read_primitive_array("float64", binary_part(binary_data, base_off + 264, 72), 9, div(72, 9))
    ...
    linear_acceleration_covariance = read_primitive_array("float64", binary_part(binary_data, base_off + 360, 72), 9, div(72, 9))
  ...
  def binary_write_recursive_imu(parent_off, heap_data, allocator, obj) do
    # member: header, type: std_msgs/Header (struct), offset: 0, size: 136
    {allocator, heap_data} =
    ...
    # member: orientation_covariance, type: float64 (primitive), offset: 168, size: 72
    allocator = add_binary(allocator, parent_off + 168, primitive_array_to_bin("float64", obj.orientation_covariance, div(72, 9)))
    ...
    # member: angular_velocity_covariance, type: float64 (primitive), offset: 264, size: 72
    allocator = add_binary(allocator, parent_off + 264, primitive_array_to_bin("float64", obj.angular_velocity_covariance, div(72, 9)))
    ...
    # member: linear_acceleration_covariance, type: float64 (primitive), offset: 360, size: 72
    allocator = add_binary(allocator, parent_off + 360, primitive_array_to_bin("float64", obj.linear_acceleration_covariance, div(72, 9)))
