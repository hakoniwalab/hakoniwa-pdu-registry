...
#include "geometry_msgs/pdu_conv_Point32.hpp"
#include "sensor_msgs/pdu_conv_ChannelFloat32.hpp"

namespace hako::godot_pdu::sensor_msgs {

inline void binary_read_recursive_PointCloud(
    ...
    int32_t base_off)
{
    ...
    }
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            godot::Dictionary child;
            hako::godot_pdu::geometry_msgs::binary_read_recursive_Point32(
                meta, binary_data, child, meta.heap_off + offset_from_heap + (i * 12));
            values.append(child);
        }
        obj["points"] = values;
    }
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            godot::Dictionary child;
            hako::godot_pdu::sensor_msgs::binary_read_recursive_ChannelFloat32(
...
inline godot::Dictionary pdu_to_godot_PointCloud(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_PointCloud(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_PointCloud(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("points")) {
        ...
        writer.heap_allocator.add(hako::godot_runtime::zero_bytes(array_size * 12), offset_from_heap);
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::geometry_msgs::binary_write_recursive_Point32(
    ...
    if (obj.has("channels")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["channels"]);
        const int32_t offset_from_heap = writer.heap_allocator.size();
        const int32_t array_size = values.size();
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::sensor_msgs::binary_write_recursive_ChannelFloat32(
...
inline godot::PackedByteArray godot_to_pdu_PointCloud(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_PointCloud(0, writer, base_allocator, obj);
