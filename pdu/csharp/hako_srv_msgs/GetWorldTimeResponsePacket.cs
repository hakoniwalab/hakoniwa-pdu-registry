...
namespace hakoniwa.pdu.msgs.hako_srv_msgs
{
    public class GetWorldTimeResponsePacket
    {
        ...
        public GetWorldTimeResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private GetWorldTimeResponse _body;
        public GetWorldTimeResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new GetWorldTimeResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
