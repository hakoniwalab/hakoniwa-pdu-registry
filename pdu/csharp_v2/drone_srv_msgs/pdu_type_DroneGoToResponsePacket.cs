...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneGoToResponsePacket
    {
        ...
        public DroneGoToResponse body { get; set; } = new DroneGoToResponse();
        ...
        public static DroneGoToResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new DroneGoToResponsePacket();
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneGoToResponse>(bodyValue, item => DroneGoToResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneGoToResponsePacket FromJson(string json)
        {
