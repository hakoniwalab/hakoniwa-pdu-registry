...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class AttachRequestPacket
    {
        ...
        public AttachRequest body { get; set; } = new AttachRequest();
        ...
        public static AttachRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AttachRequest>(bodyValue, item => AttachRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AttachRequestPacket FromJson(string json)
        {
