...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneTakeOffResponsePacket
    {
        ...
        public DroneTakeOffResponse body { get; set; } = new DroneTakeOffResponse();
        ...
        public static DroneTakeOffResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneTakeOffResponse>(bodyValue, item => DroneTakeOffResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneTakeOffResponsePacket FromJson(string json)
        {
