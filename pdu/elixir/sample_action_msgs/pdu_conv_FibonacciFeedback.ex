defmodule HakoPdu.SampleActionMsgs.FibonacciFeedbackConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_fibonacci_feedback(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.SampleActionMsgs.FibonacciFeedback.new()
    binary_read_recursive_fibonacci_feedback(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_fibonacci_feedback(obj) do
    {base_data, heap_data} = binary_write_recursive_fibonacci_feedback(0, "", "", obj)
  ...
  def binary_read_recursive_fibonacci_feedback(meta, binary_data, obj, base_off) do
    ...
    partial_sequence = read_primitive_array("int32", binary_part(binary_data, meta.heap_off + offset_from_heap, 4 * array_size), array_size, 4)
  ...
  def binary_write_recursive_fibonacci_feedback(parent_off, heap_data, allocator, obj) do
    # member: partial_sequence, type: int32 (primitive), offset: 0, size: 4
