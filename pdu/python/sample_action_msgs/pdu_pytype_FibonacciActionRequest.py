...
from ..hako_action_msgs.pdu_pytype_ActionRequestHeader import ActionRequestHeader
from ..sample_action_msgs.pdu_pytype_FibonacciGoal import FibonacciGoal
...
class FibonacciActionRequest:
    ...
    header: ActionRequestHeader
    body: FibonacciGoal

    def __init__(self):
        self.header = ActionRequestHeader()
        self.body = FibonacciGoal()

    def __str__(self):
        return f"FibonacciActionRequest(" + ", ".join([
