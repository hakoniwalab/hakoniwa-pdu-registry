...
{
    public static class Ev3PduActuatorHeaderConverter
    {
        public static Ev3PduActuatorHeader PduToMsg(byte[] binaryData)
        {
            var obj = new Ev3PduActuatorHeader();
            var meta = PduMetaData.Parse(binaryData);
            BinaryReadRecursive(meta, binaryData, obj, PduMetaData.PduMetaDataSize);
            return obj;
        }

        public static byte[] MsgToPdu(Ev3PduActuatorHeader obj)
        {
        ...
        public static void BinaryReadRecursive(PduMetaData meta, byte[] binaryData, Ev3PduActuatorHeader obj, int baseOff)
        {
            obj.name = PduRuntime.ReadString(binaryData, baseOff + 0, 128);
            obj.version = PduRuntime.ReadUInt32(binaryData, baseOff + 128);
            obj.asset_time = PduRuntime.ReadInt64(binaryData, baseOff + 136);
            obj.ext_off = PduRuntime.ReadUInt32(binaryData, baseOff + 144);
            obj.ext_size = PduRuntime.ReadUInt32(binaryData, baseOff + 148);
        }

        public static void BinaryWriteRecursive(int parentOff, BinaryWriterContainer writer, DynamicAllocator allocator, Ev3PduActuatorHeader obj)
        {
            ...
            allocator.Add(PduRuntime.GetBinaryForInt64(obj.asset_time), parentOff + 136);
