...
namespace hakoniwa.pdu.msgs.hako_srv_msgs
{
    public class GetWorldTimeRequestPacket
    {
        ...
        public GetWorldTimeRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private GetWorldTimeRequest _body;
        public GetWorldTimeRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new GetWorldTimeRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
