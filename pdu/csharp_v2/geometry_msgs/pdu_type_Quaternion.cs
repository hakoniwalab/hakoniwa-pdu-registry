...
namespace Hakoniwa.Pdu.CSharpV2.geometry_msgs
{
    public class Quaternion
    {
        ...
        public Dictionary<string, object?> ToDictionary()
        {
            ...
            dict["w"] = ToSerializableValue(w);
            return dict;
        }

        public static Quaternion FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            if (dict.TryGetValue("w", out var wValue))
            {
                obj.w = PduRuntime.ConvertValue<double>(wValue);
            }
            return obj;
        }
