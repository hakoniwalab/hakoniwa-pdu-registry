...
{
    public class GetSimStateRequestPacket
    {
        public ServiceRequestHeader header { get; set; } = new ServiceRequestHeader();
        public GetSimStateRequest body { get; set; } = new GetSimStateRequest();
        ...
        public static GetSimStateRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<GetSimStateRequest>(bodyValue, item => GetSimStateRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static GetSimStateRequestPacket FromJson(string json)
        {
