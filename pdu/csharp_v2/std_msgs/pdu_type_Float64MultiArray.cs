...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class Float64MultiArray
    {
        ...
        public static Float64MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<double>(dataValue);
            }
            return obj;
        }
        ...
        public static Float64MultiArray FromJson(string json)
        {
