...
inline void binary_read_recursive_HakoCmdHeader(
...
inline godot::Dictionary pdu_to_godot_HakoCmdHeader(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_HakoCmdHeader(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_HakoCmdHeader(
    int32_t parent_off,
...
inline godot::PackedByteArray godot_to_pdu_HakoCmdHeader(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_HakoCmdHeader(0, writer, base_allocator, obj);
