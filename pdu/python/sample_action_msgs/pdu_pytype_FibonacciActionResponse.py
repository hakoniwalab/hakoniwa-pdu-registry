...
from ..hako_action_msgs.pdu_pytype_ActionResponseHeader import ActionResponseHeader
from ..sample_action_msgs.pdu_pytype_FibonacciResult import FibonacciResult
...
class FibonacciActionResponse:
    ...
    def __init__(self):
        self.header = ActionResponseHeader()
        self.body = FibonacciResult()

    def __str__(self):
        return f"FibonacciActionResponse(" + ", ".join([
