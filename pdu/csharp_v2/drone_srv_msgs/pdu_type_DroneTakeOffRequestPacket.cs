...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneTakeOffRequestPacket
    {
        ...
        public DroneTakeOffRequest body { get; set; } = new DroneTakeOffRequest();
        ...
        public static DroneTakeOffRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneTakeOffRequest>(bodyValue, item => DroneTakeOffRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneTakeOffRequestPacket FromJson(string json)
        {
