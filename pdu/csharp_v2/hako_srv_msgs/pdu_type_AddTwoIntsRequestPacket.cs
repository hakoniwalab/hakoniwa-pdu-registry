...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class AddTwoIntsRequestPacket
    {
        ...
        public AddTwoIntsRequest body { get; set; } = new AddTwoIntsRequest();
        ...
        public static AddTwoIntsRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AddTwoIntsRequest>(bodyValue, item => AddTwoIntsRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AddTwoIntsRequestPacket FromJson(string json)
        {
