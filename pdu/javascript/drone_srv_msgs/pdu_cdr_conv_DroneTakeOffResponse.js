...
export class PduDroneTakeOffResponseConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { DroneTakeOffResponse } src
     */
     ...
     * @param { DroneTakeOffResponse } dst
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new DroneTakeOffResponse());
    }
}
