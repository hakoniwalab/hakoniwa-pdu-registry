class_name HakoPdu_std_msgs_Int32MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_Int32MultiArray:
    var obj := HakoPdu_std_msgs_Int32MultiArray.new()
    if d.has("layout"):
