defmodule HakoPdu.SensorMsgs.MagneticFieldConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_magnetic_field(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.SensorMsgs.MagneticField.new()
    binary_read_recursive_magnetic_field(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_magnetic_field(obj) do
    {base_data, heap_data} = binary_write_recursive_magnetic_field(0, "", "", obj)
  ...
  def binary_read_recursive_magnetic_field(meta, binary_data, obj, base_off) do
    ...
    magnetic_field_covariance = read_primitive_array("float64", binary_part(binary_data, base_off + 160, 72), 9, div(72, 9))
  ...
  def binary_write_recursive_magnetic_field(parent_off, heap_data, allocator, obj) do
    # member: header, type: std_msgs/Header (struct), offset: 0, size: 136
    {allocator, heap_data} =
    ...
    # member: magnetic_field_covariance, type: float64 (primitive), offset: 160, size: 72
    allocator = add_binary(allocator, parent_off + 160, primitive_array_to_bin("float64", obj.magnetic_field_covariance, div(72, 9)))
