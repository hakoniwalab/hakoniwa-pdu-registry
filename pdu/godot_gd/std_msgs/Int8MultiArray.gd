class_name HakoPdu_std_msgs_Int8MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_Int8MultiArray:
    var obj := HakoPdu_std_msgs_Int8MultiArray.new()
    if d.has("layout"):
