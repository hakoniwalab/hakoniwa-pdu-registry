...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class GetEventRequestPacket
    {
        ...
        public GetEventRequest body { get; set; } = new GetEventRequest();
        ...
        public static GetEventRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<GetEventRequest>(bodyValue, item => GetEventRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static GetEventRequestPacket FromJson(string json)
        {
