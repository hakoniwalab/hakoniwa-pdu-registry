...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneSetReadyResponsePacket
    {
        ...
        public DroneSetReadyResponse body { get; set; } = new DroneSetReadyResponse();
        ...
        public static DroneSetReadyResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneSetReadyResponse>(bodyValue, item => DroneSetReadyResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneSetReadyResponsePacket FromJson(string json)
        {
