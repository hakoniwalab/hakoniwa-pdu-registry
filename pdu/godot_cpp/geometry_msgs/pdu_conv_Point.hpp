...
inline void binary_read_recursive_Point(
...
inline godot::Dictionary pdu_to_godot_Point(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Point(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Point(
    int32_t parent_off,
...
inline godot::PackedByteArray godot_to_pdu_Point(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Point(0, writer, base_allocator, obj);
