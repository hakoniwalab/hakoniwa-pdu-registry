...
inline void binary_read_recursive_Joy(
...
inline godot::Dictionary pdu_to_godot_Joy(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Joy(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Joy(
    int32_t parent_off,
    hako::godot_runtime::BinaryWriterContainer &writer,
    hako::godot_runtime::DynamicAllocator &allocator,
    const godot::Dictionary &obj)
{
    allocator.ensure_size(parent_off + 148);
    if (obj.has("header")) {
    ...
    if (obj.has("axes")) {
        godot::PackedFloat32Array values = hako::godot_runtime::variant_to_packed_float32_array(obj["axes"]);
    ...
    if (obj.has("buttons")) {
        godot::PackedInt32Array values = hako::godot_runtime::variant_to_packed_int32_array(obj["buttons"]);
        const int32_t offset_from_heap = writer.heap_allocator.size();
        const int32_t array_size = values.size();
...
inline godot::PackedByteArray godot_to_pdu_Joy(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Joy(0, writer, base_allocator, obj);
