...
inline void binary_read_recursive_Float32MultiArray(
...
inline godot::Dictionary pdu_to_godot_Float32MultiArray(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Float32MultiArray(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Float32MultiArray(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("data")) {
        godot::PackedFloat32Array values = hako::godot_runtime::variant_to_packed_float32_array(obj["data"]);
...
inline godot::PackedByteArray godot_to_pdu_Float32MultiArray(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Float32MultiArray(0, writer, base_allocator, obj);
