...
inline void binary_read_recursive_LaserEcho(
...
inline godot::Dictionary pdu_to_godot_LaserEcho(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_LaserEcho(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_LaserEcho(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("echoes")) {
        godot::PackedFloat32Array values = hako::godot_runtime::variant_to_packed_float32_array(obj["echoes"]);
...
inline godot::PackedByteArray godot_to_pdu_LaserEcho(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_LaserEcho(0, writer, base_allocator, obj);
