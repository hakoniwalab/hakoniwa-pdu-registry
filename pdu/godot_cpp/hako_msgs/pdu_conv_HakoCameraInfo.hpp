...
inline void binary_read_recursive_HakoCameraInfo(
...
inline godot::Dictionary pdu_to_godot_HakoCameraInfo(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_HakoCameraInfo(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_HakoCameraInfo(
    int32_t parent_off,
...
inline godot::PackedByteArray godot_to_pdu_HakoCameraInfo(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_HakoCameraInfo(0, writer, base_allocator, obj);
