...
namespace Hakoniwa.Pdu.CSharpV2.geometry_msgs
{
    public class PoseArray
    {
        ...
        public List<Pose> poses { get; set; } = new List<Pose>();
        ...
        public static PoseArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.poses = PduRuntime.ConvertObjectList<Pose>(posesValue, item => Pose.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static PoseArray FromJson(string json)
        {
