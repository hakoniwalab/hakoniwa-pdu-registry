...
{
    public static class Float64MultiArrayConverter
    {
        public static Float64MultiArray PduToMsg(byte[] binaryData)
        {
            var obj = new Float64MultiArray();
            var meta = PduMetaData.Parse(binaryData);
            BinaryReadRecursive(meta, binaryData, obj, PduMetaData.PduMetaDataSize);
            return obj;
        }

        public static byte[] MsgToPdu(Float64MultiArray obj)
        {
        ...
        public static void BinaryReadRecursive(PduMetaData meta, byte[] binaryData, Float64MultiArray obj, int baseOff)
        {
        ...
        public static void BinaryWriteRecursive(int parentOff, BinaryWriterContainer writer, DynamicAllocator allocator, Float64MultiArray obj)
        {
