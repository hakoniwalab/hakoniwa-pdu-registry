class_name HakoPdu_std_msgs_UInt32MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_UInt32MultiArray:
    var obj := HakoPdu_std_msgs_UInt32MultiArray.new()
    if d.has("layout"):
