...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class GetSimStateResponsePacket
    {
        ...
        public GetSimStateResponse body { get; set; } = new GetSimStateResponse();
        ...
        public static GetSimStateResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<GetSimStateResponse>(bodyValue, item => GetSimStateResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static GetSimStateResponsePacket FromJson(string json)
        {
