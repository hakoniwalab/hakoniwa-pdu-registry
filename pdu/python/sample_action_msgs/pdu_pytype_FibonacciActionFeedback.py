...
from ..hako_action_msgs.pdu_pytype_ActionFeedbackHeader import ActionFeedbackHeader
from ..sample_action_msgs.pdu_pytype_FibonacciFeedback import FibonacciFeedback
...
class FibonacciActionFeedback:
    ...
    header: ActionFeedbackHeader
    body: FibonacciFeedback

    def __init__(self):
        self.header = ActionFeedbackHeader()
        self.body = FibonacciFeedback()

    def __str__(self):
        return f"FibonacciActionFeedback(" + ", ".join([
