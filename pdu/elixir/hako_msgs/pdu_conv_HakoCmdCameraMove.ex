defmodule HakoPdu.HakoMsgs.HakoCmdCameraMoveConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_hako_cmd_camera_move(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.HakoCmdCameraMove.new()
    binary_read_recursive_hako_cmd_camera_move(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_hako_cmd_camera_move(obj) do
    {base_data, heap_data} = binary_write_recursive_hako_cmd_camera_move(0, "", "", obj)
  ...
  def binary_read_recursive_hako_cmd_camera_move(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_hako_cmd_camera_move(parent_off, heap_data, allocator, obj) do
    # member: header, type: HakoCmdHeader (struct), offset: 0, size: 12
    {allocator, heap_data} =
