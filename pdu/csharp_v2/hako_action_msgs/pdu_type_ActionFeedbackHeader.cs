...
namespace Hakoniwa.Pdu.CSharpV2.hako_action_msgs
{
    public class ActionFeedbackHeader
    {
        ...
        public uint sequence_no { get; set; } = 0;
        ...
        public Dictionary<string, object?> ToDictionary()
        {
            ...
            dict["sequence_no"] = ToSerializableValue(sequence_no);
            return dict;
        }

        public static ActionFeedbackHeader FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            if (dict.TryGetValue("sequence_no", out var sequence_noValue))
            {
                obj.sequence_no = PduRuntime.ConvertValue<uint>(sequence_noValue);
            }
            return obj;
        }
        ...
        public static ActionFeedbackHeader FromJson(string json)
        {
