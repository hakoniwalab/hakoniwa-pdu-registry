...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class RegisterClientRequestPacket
    {
        ...
        public RegisterClientRequest body { get; set; } = new RegisterClientRequest();
        ...
        public static RegisterClientRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<RegisterClientRequest>(bodyValue, item => RegisterClientRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static RegisterClientRequestPacket FromJson(string json)
        {
