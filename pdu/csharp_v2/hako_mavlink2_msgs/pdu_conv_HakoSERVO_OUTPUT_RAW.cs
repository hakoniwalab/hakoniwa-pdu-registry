...
using Hakoniwa.Pdu.CSharpV2.hako_mavlink2_msgs;
...
namespace Hakoniwa.Pdu.CSharpV2.hako_mavlink2_msgs
{
    public static class HakoSERVO_OUTPUT_RAWConverter
    {
        ...
        public static void BinaryReadRecursive(PduMetaData meta, byte[] binaryData, HakoSERVO_OUTPUT_RAW obj, int baseOff)
        {
            ...
            obj.servo9_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 22);
            obj.servo10_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 24);
            obj.servo11_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 26);
            obj.servo12_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 28);
            obj.servo13_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 30);
            obj.servo14_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 32);
            obj.servo15_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 34);
            obj.servo16_raw = PduRuntime.ReadUInt16(binaryData, baseOff + 36);
        }
        ...
        public static void BinaryWriteRecursive(int parentOff, BinaryWriterContainer writer, DynamicAllocator allocator, HakoSERVO_OUTPUT_RAW obj)
        {
            ...
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo9_raw), parentOff + 22);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo10_raw), parentOff + 24);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo11_raw), parentOff + 26);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo12_raw), parentOff + 28);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo13_raw), parentOff + 30);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo14_raw), parentOff + 32);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo15_raw), parentOff + 34);
            allocator.Add(PduRuntime.GetBinaryForUInt16(obj.servo16_raw), parentOff + 36);
        }
    }
}
