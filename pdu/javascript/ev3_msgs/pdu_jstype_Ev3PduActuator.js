    ...
    toDict() {
        ...
        }
        {
            ...
            if (typeof field_val?.toDict === 'function') {
                ...
                d['gyro_reset'] = field_val.map(item => {
                    if (typeof item?.toDict === 'function') {
                        return item.toDict();
                    }
                    if (typeof item === 'bigint') {
                ...
                d['gyro_reset'] = field_val.toString();
            } else {
