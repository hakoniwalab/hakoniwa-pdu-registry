defmodule HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_multi_d_o_f_joint_trajectory(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectory.new()
    binary_read_recursive_multi_d_o_f_joint_trajectory(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_multi_d_o_f_joint_trajectory(obj) do
    {base_data, heap_data} = binary_write_recursive_multi_d_o_f_joint_trajectory(0, "", "", obj)
  ...
  def binary_read_recursive_multi_d_o_f_joint_trajectory(meta, binary_data, obj, base_off) do
    ...
    # member: points, type: MultiDOFJointTrajectoryPoint (struct), offset: 144, size: 32
    ...
    points =
      ...
      |> Enum.map(fn i ->
        HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryPointConverter.binary_read_recursive_multi_d_o_f_joint_trajectory_point(
          meta,
          binary_data,
          HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryPoint.new(),
  ...
  def binary_write_recursive_multi_d_o_f_joint_trajectory(parent_off, heap_data, allocator, obj) do
    # member: header, type: std_msgs/Header (struct), offset: 0, size: 136
    {allocator, heap_data} =
    ...
    heap_data =
      ...
      |> Enum.reduce(heap_data, fn {child, i}, acc_heap ->
        {new_heap_allocator, new_heap_data} =
          HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryPointConverter.binary_write_recursive_multi_d_o_f_joint_trajectory_point(
