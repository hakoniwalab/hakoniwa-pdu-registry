defmodule HakoPdu.HakoMsgs.ExecutionUnitRuntimeEpochConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_execution_unit_runtime_epoch(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.ExecutionUnitRuntimeEpoch.new()
    binary_read_recursive_execution_unit_runtime_epoch(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_execution_unit_runtime_epoch(obj) do
    {base_data, heap_data} = binary_write_recursive_execution_unit_runtime_epoch(0, "", "", obj)
  ...
  def binary_read_recursive_execution_unit_runtime_epoch(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_execution_unit_runtime_epoch(parent_off, heap_data, allocator, obj) do
    # member: epoch, type: uint8 (primitive), offset: 0, size: 1
