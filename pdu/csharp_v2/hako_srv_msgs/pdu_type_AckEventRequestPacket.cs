...
{
    public class AckEventRequestPacket
    {
        public ServiceRequestHeader header { get; set; } = new ServiceRequestHeader();
        public AckEventRequest body { get; set; } = new AckEventRequest();
        ...
        public static AckEventRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AckEventRequest>(bodyValue, item => AckEventRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AckEventRequestPacket FromJson(string json)
        {
