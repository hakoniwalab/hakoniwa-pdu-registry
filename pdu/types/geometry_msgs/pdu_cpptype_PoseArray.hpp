#ifndef _pdu_cpptype_geometry_msgs_PoseArray_HPP_
#define _pdu_cpptype_geometry_msgs_PoseArray_HPP_
...
typedef struct {
        ...
        std::vector<HakoCpp_Pose> poses;
} HakoCpp_PoseArray;

#endif /* _pdu_cpptype_geometry_msgs_PoseArray_HPP_ */
