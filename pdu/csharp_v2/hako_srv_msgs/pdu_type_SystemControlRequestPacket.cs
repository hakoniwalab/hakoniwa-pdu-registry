...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class SystemControlRequestPacket
    {
        ...
        public SystemControlRequest body { get; set; } = new SystemControlRequest();
        ...
        public static SystemControlRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<SystemControlRequest>(bodyValue, item => SystemControlRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static SystemControlRequestPacket FromJson(string json)
        {
