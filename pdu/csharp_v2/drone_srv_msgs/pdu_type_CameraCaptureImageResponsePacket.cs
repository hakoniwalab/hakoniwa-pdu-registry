...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class CameraCaptureImageResponsePacket
    {
        ...
        public CameraCaptureImageResponse body { get; set; } = new CameraCaptureImageResponse();
        ...
        public static CameraCaptureImageResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new CameraCaptureImageResponsePacket();
            ...
            {
                obj.body = PduRuntime.ConvertObject<CameraCaptureImageResponse>(bodyValue, item => CameraCaptureImageResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static CameraCaptureImageResponsePacket FromJson(string json)
        {
