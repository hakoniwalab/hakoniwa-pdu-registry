defmodule HakoPdu.HakoMsgs.HakoDroneCmdLandConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_hako_drone_cmd_land(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.HakoDroneCmdLand.new()
    binary_read_recursive_hako_drone_cmd_land(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_hako_drone_cmd_land(obj) do
    {base_data, heap_data} = binary_write_recursive_hako_drone_cmd_land(0, "", "", obj)
  ...
  def binary_read_recursive_hako_drone_cmd_land(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_hako_drone_cmd_land(parent_off, heap_data, allocator, obj) do
    # member: header, type: HakoDroneCmdHeader (struct), offset: 0, size: 12
    {allocator, heap_data} =
