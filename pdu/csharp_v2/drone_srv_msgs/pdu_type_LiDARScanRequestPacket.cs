...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class LiDARScanRequestPacket
    {
        ...
        public LiDARScanRequest body { get; set; } = new LiDARScanRequest();
        ...
        public static LiDARScanRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<LiDARScanRequest>(bodyValue, item => LiDARScanRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static LiDARScanRequestPacket FromJson(string json)
        {
