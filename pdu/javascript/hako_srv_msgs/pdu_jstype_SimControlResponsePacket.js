 ...
 */
export class SimControlResponsePacket {
/** @type { ServiceResponseHeader } */
    header;
/** @type { SimControlResponse } */
    body;


    constructor() {
        this.header = new ServiceResponseHeader();
        this.body = new SimControlResponse();
    }
     ...
     */
    static fromDict(d) {
        const obj = new SimControlResponsePacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = SimControlResponse;
            if (d.body) {
