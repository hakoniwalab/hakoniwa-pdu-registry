...
inline void binary_read_recursive_Vector3Stamped(
...
inline godot::Dictionary pdu_to_godot_Vector3Stamped(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Vector3Stamped(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Vector3Stamped(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("vector")) {
        hako::godot_pdu::geometry_msgs::binary_write_recursive_Vector3(
            ...
            writer,
            allocator,
            hako::godot_runtime::variant_to_dictionary(obj["vector"]));
    }
}

inline godot::PackedByteArray godot_to_pdu_Vector3Stamped(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Vector3Stamped(0, writer, base_allocator, obj);
