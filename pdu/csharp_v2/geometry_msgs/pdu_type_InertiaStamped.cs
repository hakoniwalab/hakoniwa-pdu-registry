...
namespace Hakoniwa.Pdu.CSharpV2.geometry_msgs
{
    public class InertiaStamped
    {
        ...
        public Dictionary<string, object?> ToDictionary()
        {
            ...
            dict["inertia"] = ToSerializableValue(inertia);
            return dict;
        }

        public static InertiaStamped FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            if (dict.TryGetValue("inertia", out var inertiaValue))
            {
                obj.inertia = PduRuntime.ConvertObject<Inertia>(inertiaValue, item => Inertia.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static InertiaStamped FromJson(string json)
        {
