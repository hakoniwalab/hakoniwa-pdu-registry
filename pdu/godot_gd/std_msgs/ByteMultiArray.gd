class_name HakoPdu_std_msgs_ByteMultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_ByteMultiArray:
    var obj := HakoPdu_std_msgs_ByteMultiArray.new()
    if d.has("layout"):
