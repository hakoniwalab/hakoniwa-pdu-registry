...
namespace Hakoniwa.Pdu.CSharpV2.geometry_msgs
{
    public class PolygonStamped
    {
        ...
        public Dictionary<string, object?> ToDictionary()
        {
            ...
            dict["polygon"] = ToSerializableValue(polygon);
            return dict;
        }

        public static PolygonStamped FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            if (dict.TryGetValue("polygon", out var polygonValue))
            {
                obj.polygon = PduRuntime.ConvertObject<Polygon>(polygonValue, item => Polygon.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static PolygonStamped FromJson(string json)
        {
