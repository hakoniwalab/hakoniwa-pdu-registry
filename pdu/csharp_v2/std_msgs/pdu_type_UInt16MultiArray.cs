...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class UInt16MultiArray
    {
        ...
        public static UInt16MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<ushort>(dataValue);
            }
            return obj;
        }
        ...
        public static UInt16MultiArray FromJson(string json)
        {
