#ifndef _pdu_ctype_geometry_msgs_PoseWithCovarianceStamped_H_
#define _pdu_ctype_geometry_msgs_PoseWithCovarianceStamped_H_
...
} Hako_PoseWithCovarianceStamped;

#endif /* _pdu_ctype_geometry_msgs_PoseWithCovarianceStamped_H_ */
