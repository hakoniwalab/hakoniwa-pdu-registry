defmodule HakoPdu.GeometryMsgs.Point32Converter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_point32(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.GeometryMsgs.Point32.new()
    binary_read_recursive_point32(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_point32(obj) do
    {base_data, heap_data} = binary_write_recursive_point32(0, "", "", obj)
  ...
  def binary_read_recursive_point32(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_point32(parent_off, heap_data, allocator, obj) do
    # member: x, type: float32 (primitive), offset: 0, size: 4
