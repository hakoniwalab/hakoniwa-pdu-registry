...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneSetReadyRequestPacket
    {
        ...
        public DroneSetReadyRequest body { get; set; } = new DroneSetReadyRequest();
        ...
        public static DroneSetReadyRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneSetReadyRequest>(bodyValue, item => DroneSetReadyRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneSetReadyRequestPacket FromJson(string json)
        {
