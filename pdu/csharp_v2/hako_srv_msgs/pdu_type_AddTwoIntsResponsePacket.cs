...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class AddTwoIntsResponsePacket
    {
        ...
        public AddTwoIntsResponse body { get; set; } = new AddTwoIntsResponse();
        ...
        public static AddTwoIntsResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AddTwoIntsResponse>(bodyValue, item => AddTwoIntsResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AddTwoIntsResponsePacket FromJson(string json)
        {
