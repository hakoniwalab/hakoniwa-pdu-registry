...
export class PduFloat64MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { Float64MultiArray } src
     */
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new Float64MultiArray());
    }
}
