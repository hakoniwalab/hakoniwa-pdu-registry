...
{
    public class GetWorldTimeRequestPacket
    {
        public ServiceRequestHeader header { get; set; } = new ServiceRequestHeader();
        public GetWorldTimeRequest body { get; set; } = new GetWorldTimeRequest();
        ...
        public static GetWorldTimeRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<GetWorldTimeRequest>(bodyValue, item => GetWorldTimeRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static GetWorldTimeRequestPacket FromJson(string json)
        {
