...
from ..hako_srv_msgs.pdu_pytype_NotifyAssetTimeRequest import NotifyAssetTimeRequest
...
class NotifyAssetTimeRequestPacket:
    ...
    body: NotifyAssetTimeRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = NotifyAssetTimeRequest()

    def __str__(self):
        return f"NotifyAssetTimeRequestPacket(" + ", ".join([
