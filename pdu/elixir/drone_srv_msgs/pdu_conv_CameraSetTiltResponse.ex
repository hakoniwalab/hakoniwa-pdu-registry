defmodule HakoPdu.DroneSrvMsgs.CameraSetTiltResponseConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_camera_set_tilt_response(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.DroneSrvMsgs.CameraSetTiltResponse.new()
    binary_read_recursive_camera_set_tilt_response(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_camera_set_tilt_response(obj) do
    {base_data, heap_data} = binary_write_recursive_camera_set_tilt_response(0, "", "", obj)
  ...
  def binary_read_recursive_camera_set_tilt_response(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_camera_set_tilt_response(parent_off, heap_data, allocator, obj) do
    # member: ok, type: bool (primitive), offset: 0, size: 4
