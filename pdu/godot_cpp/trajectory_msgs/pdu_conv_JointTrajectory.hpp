...
#include "trajectory_msgs/pdu_conv_JointTrajectoryPoint.hpp"

namespace hako::godot_pdu::trajectory_msgs {

inline void binary_read_recursive_JointTrajectory(
    ...
    int32_t base_off)
{
    ...
    }
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            godot::Dictionary child;
            hako::godot_pdu::trajectory_msgs::binary_read_recursive_JointTrajectoryPoint(
                meta, binary_data, child, meta.heap_off + offset_from_heap + (i * 40));
            values.append(child);
        }
        obj["points"] = values;
    }
...
inline godot::Dictionary pdu_to_godot_JointTrajectory(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_JointTrajectory(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_JointTrajectory(
    int32_t parent_off,
    hako::godot_runtime::BinaryWriterContainer &writer,
    hako::godot_runtime::DynamicAllocator &allocator,
    const godot::Dictionary &obj)
{
    allocator.ensure_size(parent_off + 184);
    if (obj.has("header")) {
    ...
    if (obj.has("points")) {
        ...
        writer.heap_allocator.add(hako::godot_runtime::zero_bytes(array_size * 40), offset_from_heap);
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::trajectory_msgs::binary_write_recursive_JointTrajectoryPoint(
...
inline godot::PackedByteArray godot_to_pdu_JointTrajectory(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_JointTrajectory(0, writer, base_allocator, obj);
