...
{
    public class AckEventResponsePacket
    {
        public ServiceResponseHeader header { get; set; } = new ServiceResponseHeader();
        public AckEventResponse body { get; set; } = new AckEventResponse();
        ...
        public static AckEventResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<AckEventResponse>(bodyValue, item => AckEventResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static AckEventResponsePacket FromJson(string json)
        {
