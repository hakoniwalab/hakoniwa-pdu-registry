...
#include "geometry_msgs/pdu_conv_Wrench.hpp"

namespace hako::godot_pdu::sensor_msgs {

inline void binary_read_recursive_MultiDOFJointState(
    ...
    int32_t base_off)
{
    ...
    }
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            godot::Dictionary child;
            hako::godot_pdu::geometry_msgs::binary_read_recursive_Wrench(
                meta, binary_data, child, meta.heap_off + offset_from_heap + (i * 48));
            values.append(child);
        }
        obj["wrench"] = values;
...
inline godot::Dictionary pdu_to_godot_MultiDOFJointState(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_MultiDOFJointState(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_MultiDOFJointState(
    int32_t parent_off,
    hako::godot_runtime::BinaryWriterContainer &writer,
    hako::godot_runtime::DynamicAllocator &allocator,
    const godot::Dictionary &obj)
{
    allocator.ensure_size(parent_off + 208);
    if (obj.has("header")) {
    ...
    if (obj.has("twist")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["twist"]);
        const int32_t offset_from_heap = writer.heap_allocator.size();
        const int32_t array_size = values.size();
    ...
    if (obj.has("wrench")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["wrench"]);
        const int32_t offset_from_heap = writer.heap_allocator.size();
        const int32_t array_size = values.size();
        ...
        writer.heap_allocator.add(hako::godot_runtime::zero_bytes(array_size * 48), offset_from_heap);
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::geometry_msgs::binary_write_recursive_Wrench(
                offset_from_heap + (i * 48),
                writer,
                writer.heap_allocator,
                hako::godot_runtime::variant_to_dictionary(values[i]));
...
inline godot::PackedByteArray godot_to_pdu_MultiDOFJointState(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_MultiDOFJointState(0, writer, base_allocator, obj);
