...
{
    public class SimControlResponse
    {
        ...
        public static SimControlResponse FromDictionary(Dictionary<string, object?> dict)
        {
        ...
        public static SimControlResponse FromJson(string json)
        {
