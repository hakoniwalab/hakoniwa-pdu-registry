defmodule HakoPdu.GeometryMsgs.PoseArrayConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_pose_array(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.GeometryMsgs.PoseArray.new()
    binary_read_recursive_pose_array(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_pose_array(obj) do
    {base_data, heap_data} = binary_write_recursive_pose_array(0, "", "", obj)
  ...
  def binary_read_recursive_pose_array(meta, binary_data, obj, base_off) do
    ...
    # member: poses, type: Pose (struct), offset: 136, size: 56
  ...
  def binary_write_recursive_pose_array(parent_off, heap_data, allocator, obj) do
    # member: header, type: std_msgs/Header (struct), offset: 0, size: 136
    {allocator, heap_data} =
