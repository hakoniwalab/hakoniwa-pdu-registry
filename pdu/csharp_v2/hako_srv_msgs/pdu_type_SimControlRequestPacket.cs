...
{
    public class SimControlRequestPacket
    {
        public ServiceRequestHeader header { get; set; } = new ServiceRequestHeader();
        public SimControlRequest body { get; set; } = new SimControlRequest();
        ...
        public static SimControlRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<SimControlRequest>(bodyValue, item => SimControlRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static SimControlRequestPacket FromJson(string json)
        {
