...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class CameraSetTiltRequestPacket
    {
        ...
        public CameraSetTiltRequest body { get; set; } = new CameraSetTiltRequest();
        ...
        public static CameraSetTiltRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<CameraSetTiltRequest>(bodyValue, item => CameraSetTiltRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static CameraSetTiltRequestPacket FromJson(string json)
        {
