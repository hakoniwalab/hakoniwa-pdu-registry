class_name HakoPdu_std_msgs_UInt64MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_UInt64MultiArray:
    var obj := HakoPdu_std_msgs_UInt64MultiArray.new()
    if d.has("layout"):
