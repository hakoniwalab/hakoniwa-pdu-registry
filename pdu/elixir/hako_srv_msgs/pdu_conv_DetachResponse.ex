defmodule HakoPdu.HakoSrvMsgs.DetachResponseConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_detach_response(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoSrvMsgs.DetachResponse.new()
    binary_read_recursive_detach_response(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_detach_response(obj) do
    {base_data, heap_data} = binary_write_recursive_detach_response(0, "", "", obj)
  ...
  def binary_read_recursive_detach_response(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_detach_response(parent_off, heap_data, allocator, obj) do
    # member: result_code, type: uint32 (primitive), offset: 0, size: 4
