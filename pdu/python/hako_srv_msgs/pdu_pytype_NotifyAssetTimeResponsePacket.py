...
from ..hako_srv_msgs.pdu_pytype_NotifyAssetTimeResponse import NotifyAssetTimeResponse
...
class NotifyAssetTimeResponsePacket:
    ...
    body: NotifyAssetTimeResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = NotifyAssetTimeResponse()

    def __str__(self):
        return f"NotifyAssetTimeResponsePacket(" + ", ".join([
