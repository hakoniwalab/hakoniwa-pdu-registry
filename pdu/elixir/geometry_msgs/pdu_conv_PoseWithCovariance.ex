defmodule HakoPdu.GeometryMsgs.PoseWithCovarianceConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_pose_with_covariance(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.GeometryMsgs.PoseWithCovariance.new()
    binary_read_recursive_pose_with_covariance(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_pose_with_covariance(obj) do
    {base_data, heap_data} = binary_write_recursive_pose_with_covariance(0, "", "", obj)
  ...
  def binary_read_recursive_pose_with_covariance(meta, binary_data, obj, base_off) do
    ...
    covariance = read_primitive_array("float64", binary_part(binary_data, base_off + 56, 288), 36, div(288, 36))
  ...
  def binary_write_recursive_pose_with_covariance(parent_off, heap_data, allocator, obj) do
    # member: pose, type: Pose (struct), offset: 0, size: 56
    {allocator, heap_data} =
    ...
    # member: covariance, type: float64 (primitive), offset: 56, size: 288
    allocator = add_binary(allocator, parent_off + 56, primitive_array_to_bin("float64", obj.covariance, div(288, 36)))
