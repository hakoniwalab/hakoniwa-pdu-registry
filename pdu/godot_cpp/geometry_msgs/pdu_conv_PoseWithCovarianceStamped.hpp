...
inline void binary_read_recursive_PoseWithCovarianceStamped(
...
inline godot::Dictionary pdu_to_godot_PoseWithCovarianceStamped(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_PoseWithCovarianceStamped(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_PoseWithCovarianceStamped(
    int32_t parent_off,
    hako::godot_runtime::BinaryWriterContainer &writer,
    hako::godot_runtime::DynamicAllocator &allocator,
    const godot::Dictionary &obj)
{
    allocator.ensure_size(parent_off + 480);
    if (obj.has("header")) {
...
inline godot::PackedByteArray godot_to_pdu_PoseWithCovarianceStamped(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_PoseWithCovarianceStamped(0, writer, base_allocator, obj);
