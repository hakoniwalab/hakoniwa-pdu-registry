...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class MagnetGrabRequestPacket
    {
        ...
        public MagnetGrabRequest body { get; set; } = new MagnetGrabRequest();
        ...
        public static MagnetGrabRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<MagnetGrabRequest>(bodyValue, item => MagnetGrabRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static MagnetGrabRequestPacket FromJson(string json)
        {
