defmodule HakoPdu.HakoMsgs.HakoCmdCameraConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_hako_cmd_camera(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.HakoCmdCamera.new()
    binary_read_recursive_hako_cmd_camera(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_hako_cmd_camera(obj) do
    {base_data, heap_data} = binary_write_recursive_hako_cmd_camera(0, "", "", obj)
  ...
  def binary_read_recursive_hako_cmd_camera(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_hako_cmd_camera(parent_off, heap_data, allocator, obj) do
    # member: header, type: HakoCmdHeader (struct), offset: 0, size: 12
    {allocator, heap_data} =
