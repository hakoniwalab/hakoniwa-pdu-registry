...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class Float32
    {
        ...
        public static Float32 FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new Float32();
            if (dict.TryGetValue("data", out var dataValue))
            {
                obj.data = PduRuntime.ConvertValue<float>(dataValue);
            }
            return obj;
        }
        ...
        public static Float32 FromJson(string json)
        {
