...
#include "sensor_msgs/pdu_conv_LaserEcho.hpp"

namespace hako::godot_pdu::sensor_msgs {

inline void binary_read_recursive_MultiEchoLaserScan(
    ...
    int32_t base_off)
{
        ...
        binary_data, base_off + 160);
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            godot::Dictionary child;
            hako::godot_pdu::sensor_msgs::binary_read_recursive_LaserEcho(
...
inline godot::Dictionary pdu_to_godot_MultiEchoLaserScan(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_MultiEchoLaserScan(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_MultiEchoLaserScan(
    int32_t parent_off,
    hako::godot_runtime::BinaryWriterContainer &writer,
    hako::godot_runtime::DynamicAllocator &allocator,
    const godot::Dictionary &obj)
{
    allocator.ensure_size(parent_off + 180);
    if (obj.has("header")) {
    ...
    if (obj.has("ranges")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["ranges"]);
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::sensor_msgs::binary_write_recursive_LaserEcho(
    ...
    if (obj.has("intensities")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["intensities"]);
        const int32_t offset_from_heap = writer.heap_allocator.size();
        const int32_t array_size = values.size();
...
inline godot::PackedByteArray godot_to_pdu_MultiEchoLaserScan(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_MultiEchoLaserScan(0, writer, base_allocator, obj);
