...
export class PduUInt16MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { UInt16MultiArray } src
     */
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new UInt16MultiArray());
    }
}
