...
inline void binary_read_recursive_ActionFeedbackHeader(
    ...
    int32_t base_off)
{
    ...
    obj["sequence_no"] = hako::godot_runtime::read_uint32(
        binary_data, base_off + 20);
}

inline godot::Dictionary pdu_to_godot_ActionFeedbackHeader(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_ActionFeedbackHeader(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_ActionFeedbackHeader(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("sequence_no")) {
        allocator.add(
            hako::godot_runtime::get_binary_for_uint32(
                hako::godot_runtime::variant_to_uint32(obj["sequence_no"])),
            parent_off + 20);
    }
}

inline godot::PackedByteArray godot_to_pdu_ActionFeedbackHeader(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_ActionFeedbackHeader(0, writer, base_allocator, obj);
