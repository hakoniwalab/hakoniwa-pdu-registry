...
inline void binary_read_recursive_Int8MultiArray(
...
inline godot::Dictionary pdu_to_godot_Int8MultiArray(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Int8MultiArray(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Int8MultiArray(
    int32_t parent_off,
...
inline godot::PackedByteArray godot_to_pdu_Int8MultiArray(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Int8MultiArray(0, writer, base_allocator, obj);
