defmodule HakoPdu.DroneSrvMsgs.LiDARScanRequestConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_li_d_a_r_scan_request(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.DroneSrvMsgs.LiDARScanRequest.new()
    binary_read_recursive_li_d_a_r_scan_request(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_li_d_a_r_scan_request(obj) do
    {base_data, heap_data} = binary_write_recursive_li_d_a_r_scan_request(0, "", "", obj)
  ...
  def binary_read_recursive_li_d_a_r_scan_request(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_li_d_a_r_scan_request(parent_off, heap_data, allocator, obj) do
    # member: drone_name, type: string (primitive), offset: 0, size: 128
