...
namespace hakoniwa.pdu.msgs.trajectory_msgs
{
    public class MultiDOFJointTrajectory
    {
        ...
        public MultiDOFJointTrajectory(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private MultiDOFJointTrajectoryPoint[] _points;
        public MultiDOFJointTrajectoryPoint[] points
        {
            get
            {
                if (_points == null)
                {
                    ...
                    _points = new MultiDOFJointTrajectoryPoint[fieldPdus.Length];
                    MultiDOFJointTrajectoryPoint[] result = new MultiDOFJointTrajectoryPoint[fieldPdus.Length];
                    for (int i = 0; i < fieldPdus.Length; i++)
                    {
                        _points[i] = new MultiDOFJointTrajectoryPoint(fieldPdus[i]);
                    }
                }
                return _points;
            }
            set
            {
                _points = new MultiDOFJointTrajectoryPoint[value.Length];
