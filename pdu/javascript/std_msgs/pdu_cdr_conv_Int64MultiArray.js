...
export class PduInt64MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { Int64MultiArray } src
     */
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new Int64MultiArray());
    }
}
