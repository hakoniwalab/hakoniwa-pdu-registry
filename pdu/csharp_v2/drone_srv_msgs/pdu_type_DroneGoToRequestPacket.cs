...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneGoToRequestPacket
    {
        ...
        public DroneGoToRequest body { get; set; } = new DroneGoToRequest();
        ...
        public static DroneGoToRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneGoToRequest>(bodyValue, item => DroneGoToRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneGoToRequestPacket FromJson(string json)
        {
