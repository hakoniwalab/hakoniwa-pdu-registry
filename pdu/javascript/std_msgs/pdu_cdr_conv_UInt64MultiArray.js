...
export class PduUInt64MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { UInt64MultiArray } src
     */
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new UInt64MultiArray());
    }
}
