...
inline void binary_read_recursive_UInt16MultiArray(
    ...
    int32_t base_off)
{
    ...
    }
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            values.append(hako::godot_runtime::read_uint16(
...
inline godot::Dictionary pdu_to_godot_UInt16MultiArray(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_UInt16MultiArray(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_UInt16MultiArray(
    int32_t parent_off,
    ...
    if (obj.has("data")) {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            writer.heap_allocator.add(
                hako::godot_runtime::get_binary_for_uint16(hako::godot_runtime::variant_to_uint16(values[i])));
        }
    }
}

inline godot::PackedByteArray godot_to_pdu_UInt16MultiArray(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_UInt16MultiArray(0, writer, base_allocator, obj);
