...
from ..hako_srv_msgs.pdu_pytype_GetWorldTimeResponse import GetWorldTimeResponse
...
class GetWorldTimeResponsePacket:
    ...
    body: GetWorldTimeResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = GetWorldTimeResponse()

    def __str__(self):
        return f"GetWorldTimeResponsePacket(" + ", ".join([
