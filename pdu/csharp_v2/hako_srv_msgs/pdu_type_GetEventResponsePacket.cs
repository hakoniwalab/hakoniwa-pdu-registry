...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class GetEventResponsePacket
    {
        ...
        public GetEventResponse body { get; set; } = new GetEventResponse();
        ...
        public static GetEventResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<GetEventResponse>(bodyValue, item => GetEventResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static GetEventResponsePacket FromJson(string json)
        {
