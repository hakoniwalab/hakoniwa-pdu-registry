defmodule HakoPdu.HakoMsgs.SimTimeConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_sim_time(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.HakoMsgs.SimTime.new()
    binary_read_recursive_sim_time(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_sim_time(obj) do
    {base_data, heap_data} = binary_write_recursive_sim_time(0, "", "", obj)
  ...
  def binary_read_recursive_sim_time(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_sim_time(parent_off, heap_data, allocator, obj) do
    # member: time_usec, type: uint64 (primitive), offset: 0, size: 8
