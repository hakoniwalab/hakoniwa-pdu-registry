...
export class PduFloat32MultiArrayConverter {
    /**
     * @param {PduCdrWriter} writer
     * @param { Float32MultiArray } src
     */
     ...
     * @param { Float32MultiArray } dst
     * @returns { Float32MultiArray }
     */
    static cdr_body_to_js(reader, dst) {
        PduMultiArrayLayoutConverter.cdr_body_to_js(reader, dst.layout);
        dst.data = Array.from({ length: reader.read_uint32() }, () => reader.read_float32());
        return dst;
    }
    ...
    static from_cdr(cdrPayload) {
        ...
        return this.cdr_body_to_js(reader, new Float32MultiArray());
    }
}
