defmodule HakoPdu.DroneSrvMsgs.DroneGetStateRequestConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_drone_get_state_request(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.DroneSrvMsgs.DroneGetStateRequest.new()
    binary_read_recursive_drone_get_state_request(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_drone_get_state_request(obj) do
    {base_data, heap_data} = binary_write_recursive_drone_get_state_request(0, "", "", obj)
  ...
  def binary_read_recursive_drone_get_state_request(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_drone_get_state_request(parent_off, heap_data, allocator, obj) do
    # member: drone_name, type: string (primitive), offset: 0, size: 128
