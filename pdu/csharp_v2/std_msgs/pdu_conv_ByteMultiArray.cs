...
{
    public static class ByteMultiArrayConverter
    {
        public static ByteMultiArray PduToMsg(byte[] binaryData)
        {
            var obj = new ByteMultiArray();
            var meta = PduMetaData.Parse(binaryData);
            BinaryReadRecursive(meta, binaryData, obj, PduMetaData.PduMetaDataSize);
            return obj;
        }

        public static byte[] MsgToPdu(ByteMultiArray obj)
        {
        ...
        public static void BinaryReadRecursive(PduMetaData meta, byte[] binaryData, ByteMultiArray obj, int baseOff)
        {
        ...
        public static void BinaryWriteRecursive(int parentOff, BinaryWriterContainer writer, DynamicAllocator allocator, ByteMultiArray obj)
        {
