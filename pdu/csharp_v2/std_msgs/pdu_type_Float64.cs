...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class Float64
    {
        ...
        public static Float64 FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new Float64();
            if (dict.TryGetValue("data", out var dataValue))
            {
                obj.data = PduRuntime.ConvertValue<double>(dataValue);
            }
            return obj;
        }
        ...
        public static Float64 FromJson(string json)
        {
