...
namespace Hakoniwa.Pdu.CSharpV2.hako_srv_msgs
{
    public class JoinRequestPacket
    {
        ...
        public JoinRequest body { get; set; } = new JoinRequest();
        ...
        public static JoinRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<JoinRequest>(bodyValue, item => JoinRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static JoinRequestPacket FromJson(string json)
        {
