...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class DroneLandRequestPacket
    {
        ...
        public DroneLandRequest body { get; set; } = new DroneLandRequest();
        ...
        public static DroneLandRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DroneLandRequest>(bodyValue, item => DroneLandRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DroneLandRequestPacket FromJson(string json)
        {
