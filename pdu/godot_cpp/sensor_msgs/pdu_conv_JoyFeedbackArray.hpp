...
#include "sensor_msgs/pdu_conv_JoyFeedback.hpp"

namespace hako::godot_pdu::sensor_msgs {

inline void binary_read_recursive_JoyFeedbackArray(
...
{
    {
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            ...
            hako::godot_pdu::sensor_msgs::binary_read_recursive_JoyFeedback(
...
inline godot::Dictionary pdu_to_godot_JoyFeedbackArray(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_JoyFeedbackArray(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_JoyFeedbackArray(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("array")) {
        godot::Array values = hako::godot_runtime::variant_to_array(obj["array"]);
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            hako::godot_pdu::sensor_msgs::binary_write_recursive_JoyFeedback(
...
inline godot::PackedByteArray godot_to_pdu_JoyFeedbackArray(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_JoyFeedbackArray(0, writer, base_allocator, obj);
