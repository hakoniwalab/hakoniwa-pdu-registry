...
{
    public class SimControlResponsePacket
    {
        public ServiceResponseHeader header { get; set; } = new ServiceResponseHeader();
        public SimControlResponse body { get; set; } = new SimControlResponse();
        ...
        public static SimControlResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<SimControlResponse>(bodyValue, item => SimControlResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static SimControlResponsePacket FromJson(string json)
        {
