...
{
    public class GetSimStateRequest
    {
        ...
        public static GetSimStateRequest FromDictionary(Dictionary<string, object?> dict)
        {
        ...
        public static GetSimStateRequest FromJson(string json)
        {
