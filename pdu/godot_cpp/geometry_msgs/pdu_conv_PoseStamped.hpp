...
inline void binary_read_recursive_PoseStamped(
...
inline godot::Dictionary pdu_to_godot_PoseStamped(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_PoseStamped(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_PoseStamped(
    int32_t parent_off,
...
inline godot::PackedByteArray godot_to_pdu_PoseStamped(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_PoseStamped(0, writer, base_allocator, obj);
