...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class UInt64MultiArray
    {
        ...
        public static UInt64MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<ulong>(dataValue);
            }
            return obj;
        }
        ...
        public static UInt64MultiArray FromJson(string json)
        {
