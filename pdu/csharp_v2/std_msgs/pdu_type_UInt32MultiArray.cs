...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class UInt32MultiArray
    {
        ...
        public static UInt32MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<uint>(dataValue);
            }
            return obj;
        }
        ...
        public static UInt32MultiArray FromJson(string json)
        {
