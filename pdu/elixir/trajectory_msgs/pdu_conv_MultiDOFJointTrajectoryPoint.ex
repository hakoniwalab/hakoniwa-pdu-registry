defmodule HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryPointConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_multi_d_o_f_joint_trajectory_point(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.TrajectoryMsgs.MultiDOFJointTrajectoryPoint.new()
    binary_read_recursive_multi_d_o_f_joint_trajectory_point(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_multi_d_o_f_joint_trajectory_point(obj) do
    {base_data, heap_data} = binary_write_recursive_multi_d_o_f_joint_trajectory_point(0, "", "", obj)
  ...
  def binary_read_recursive_multi_d_o_f_joint_trajectory_point(meta, binary_data, obj, base_off) do
  ...
  def binary_write_recursive_multi_d_o_f_joint_trajectory_point(parent_off, heap_data, allocator, obj) do
    # member: transforms, type: geometry_msgs/Transform (struct), offset: 0, size: 56
