defmodule HakoPdu.DroneSrvMsgs.DroneGetStateResponsePacketConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_drone_get_state_response_packet(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.DroneSrvMsgs.DroneGetStateResponsePacket.new()
    binary_read_recursive_drone_get_state_response_packet(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_drone_get_state_response_packet(obj) do
    {base_data, heap_data} = binary_write_recursive_drone_get_state_response_packet(0, "", "", obj)
  ...
  def binary_read_recursive_drone_get_state_response_packet(meta, binary_data, obj, base_off) do
    ...
    body =
      HakoPdu.DroneSrvMsgs.DroneGetStateResponseConverter.binary_read_recursive_drone_get_state_response(
        meta,
        binary_data,
        HakoPdu.DroneSrvMsgs.DroneGetStateResponse.new(),
        base_off + 272
      )
  ...
  def binary_write_recursive_drone_get_state_response_packet(parent_off, heap_data, allocator, obj) do
    # member: header, type: hako_srv_msgs/ServiceResponseHeader (struct), offset: 0, size: 268
    {allocator, heap_data} =
    ...
    # member: body, type: DroneGetStateResponse (struct), offset: 272, size: 352
    {allocator, heap_data} =
      HakoPdu.DroneSrvMsgs.DroneGetStateResponseConverter.binary_write_recursive_drone_get_state_response(
        parent_off + 272,
        heap_data,
        allocator,
        obj.body
