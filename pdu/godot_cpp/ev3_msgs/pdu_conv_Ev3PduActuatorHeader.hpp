...
inline void binary_read_recursive_Ev3PduActuatorHeader(
    ...
    int32_t base_off)
{
    ...
    obj["asset_time"] = hako::godot_runtime::read_int64(
...
inline godot::Dictionary pdu_to_godot_Ev3PduActuatorHeader(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Ev3PduActuatorHeader(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Ev3PduActuatorHeader(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("asset_time")) {
        allocator.add(
            hako::godot_runtime::get_binary_for_int64(
                hako::godot_runtime::variant_to_int64(obj["asset_time"])),
            parent_off + 136);
    }
    if (obj.has("ext_off")) {
        allocator.add(
...
inline godot::PackedByteArray godot_to_pdu_Ev3PduActuatorHeader(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Ev3PduActuatorHeader(0, writer, base_allocator, obj);
