...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class MagnetGrabResponsePacket
    {
        ...
        public MagnetGrabResponse body { get; set; } = new MagnetGrabResponse();
        ...
        public static MagnetGrabResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            var obj = new MagnetGrabResponsePacket();
            ...
            {
                obj.body = PduRuntime.ConvertObject<MagnetGrabResponse>(bodyValue, item => MagnetGrabResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static MagnetGrabResponsePacket FromJson(string json)
        {
