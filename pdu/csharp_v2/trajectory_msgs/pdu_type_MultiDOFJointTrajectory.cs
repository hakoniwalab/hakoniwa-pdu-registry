...
namespace Hakoniwa.Pdu.CSharpV2.trajectory_msgs
{
    public class MultiDOFJointTrajectory
    {
        ...
        public List<MultiDOFJointTrajectoryPoint> points { get; set; } = new List<MultiDOFJointTrajectoryPoint>();
        ...
        public static MultiDOFJointTrajectory FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.points = PduRuntime.ConvertObjectList<MultiDOFJointTrajectoryPoint>(pointsValue, item => MultiDOFJointTrajectoryPoint.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static MultiDOFJointTrajectory FromJson(string json)
        {
