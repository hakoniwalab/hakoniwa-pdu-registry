...
inline void binary_read_recursive_Int64MultiArray(
    ...
    int32_t base_off)
{
    ...
    }
    {
        ...
        godot::PackedInt64Array values;
        for (int32_t i = 0; i < array_size; ++i) {
            values.append(hako::godot_runtime::read_int64(
...
inline godot::Dictionary pdu_to_godot_Int64MultiArray(const godot::PackedByteArray &binary_data)
{
    godot::Dictionary obj;
    ...
    binary_read_recursive_Int64MultiArray(meta, binary_data, obj, hako::godot_runtime::PduMetaData::PDU_META_DATA_SIZE);
    return obj;
}

inline void binary_write_recursive_Int64MultiArray(
    int32_t parent_off,
    ...
    const godot::Dictionary &obj)
{
    ...
    if (obj.has("data")) {
        godot::PackedInt64Array values = hako::godot_runtime::variant_to_packed_int64_array(obj["data"]);
        ...
        for (int32_t i = 0; i < array_size; ++i) {
            writer.heap_allocator.add(
                hako::godot_runtime::get_binary_for_int64(values[i]));
        }
    }
}

inline godot::PackedByteArray godot_to_pdu_Int64MultiArray(const godot::Dictionary &obj)
{
    hako::godot_runtime::DynamicAllocator base_allocator;
    hako::godot_runtime::BinaryWriterContainer writer;
    binary_write_recursive_Int64MultiArray(0, writer, base_allocator, obj);
