 ...
 */
export class NotifyAssetTimeResponsePacket {
...
/** @type { NotifyAssetTimeResponse } */
    ...
    constructor() {
        ...
        this.body = new NotifyAssetTimeResponse();
    }
     ...
     */
    static fromDict(d) {
        const obj = new NotifyAssetTimeResponsePacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = NotifyAssetTimeResponse;
            if (d.body) {
