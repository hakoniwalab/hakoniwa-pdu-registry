class_name HakoPdu_std_msgs_Int16MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_Int16MultiArray:
    var obj := HakoPdu_std_msgs_Int16MultiArray.new()
    if d.has("layout"):
