 ...
 */
export class AckEventResponsePacket {
/** @type { ServiceResponseHeader } */
    header;
/** @type { AckEventResponse } */
    body;


    constructor() {
        this.header = new ServiceResponseHeader();
        this.body = new AckEventResponse();
    }
     ...
     */
    static fromDict(d) {
        const obj = new AckEventResponsePacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = AckEventResponse;
            if (d.body) {
