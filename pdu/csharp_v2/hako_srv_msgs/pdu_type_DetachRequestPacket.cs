...
{
    public class DetachRequestPacket
    {
        public ServiceRequestHeader header { get; set; } = new ServiceRequestHeader();
        public DetachRequest body { get; set; } = new DetachRequest();
        ...
        public static DetachRequestPacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<DetachRequest>(bodyValue, item => DetachRequest.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static DetachRequestPacket FromJson(string json)
        {
