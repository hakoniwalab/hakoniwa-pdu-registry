class_name HakoPdu_std_msgs_Float32MultiArray
extends RefCounted
...
static func from_dict(d: Dictionary) -> HakoPdu_std_msgs_Float32MultiArray:
    var obj := HakoPdu_std_msgs_Float32MultiArray.new()
    if d.has("layout"):
