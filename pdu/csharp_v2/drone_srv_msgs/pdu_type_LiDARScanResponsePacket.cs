...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class LiDARScanResponsePacket
    {
        ...
        public LiDARScanResponse body { get; set; } = new LiDARScanResponse();
        ...
        public static LiDARScanResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<LiDARScanResponse>(bodyValue, item => LiDARScanResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static LiDARScanResponsePacket FromJson(string json)
        {
