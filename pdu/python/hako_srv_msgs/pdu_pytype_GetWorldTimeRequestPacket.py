...
from ..hako_srv_msgs.pdu_pytype_GetWorldTimeRequest import GetWorldTimeRequest
...
class GetWorldTimeRequestPacket:
    ...
    body: GetWorldTimeRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = GetWorldTimeRequest()

    def __str__(self):
        return f"GetWorldTimeRequestPacket(" + ", ".join([
