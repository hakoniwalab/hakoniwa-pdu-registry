defmodule HakoPdu.GeometryMsgs.AccelWithCovarianceStampedConverter do
  @pdu_meta_data_size 24
  @pdu_meta_data_magicno 0x12345678
  @pdu_meta_data_version 1

  def pdu_to_elixir_accel_with_covariance_stamped(binary_data) when is_binary(binary_data) do
    meta = load_pdu_meta(binary_data)
    obj = HakoPdu.GeometryMsgs.AccelWithCovarianceStamped.new()
    binary_read_recursive_accel_with_covariance_stamped(meta, binary_data, obj, meta.base_off)
  end

  def elixir_to_pdu_accel_with_covariance_stamped(obj) do
    {base_data, heap_data} = binary_write_recursive_accel_with_covariance_stamped(0, "", "", obj)
  ...
  def binary_read_recursive_accel_with_covariance_stamped(meta, binary_data, obj, base_off) do
    ...
    accel =
      HakoPdu.GeometryMsgs.AccelWithCovarianceConverter.binary_read_recursive_accel_with_covariance(
        meta,
        binary_data,
        HakoPdu.GeometryMsgs.AccelWithCovariance.new(),
        base_off + 136
      )
  ...
  def binary_write_recursive_accel_with_covariance_stamped(parent_off, heap_data, allocator, obj) do
    # member: header, type: std_msgs/Header (struct), offset: 0, size: 136
    {allocator, heap_data} =
    ...
    # member: accel, type: AccelWithCovariance (struct), offset: 136, size: 336
    {allocator, heap_data} =
      HakoPdu.GeometryMsgs.AccelWithCovarianceConverter.binary_write_recursive_accel_with_covariance(
        parent_off + 136,
        heap_data,
        allocator,
        obj.accel
