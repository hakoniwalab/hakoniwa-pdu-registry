...
namespace Hakoniwa.Pdu.CSharpV2.drone_srv_msgs
{
    public class CameraSetTiltResponsePacket
    {
        ...
        public CameraSetTiltResponse body { get; set; } = new CameraSetTiltResponse();
        ...
        public static CameraSetTiltResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<CameraSetTiltResponse>(bodyValue, item => CameraSetTiltResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static CameraSetTiltResponsePacket FromJson(string json)
        {
