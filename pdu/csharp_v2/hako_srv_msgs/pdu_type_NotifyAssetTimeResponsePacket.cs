...
{
    public class NotifyAssetTimeResponsePacket
    {
        public ServiceResponseHeader header { get; set; } = new ServiceResponseHeader();
        public NotifyAssetTimeResponse body { get; set; } = new NotifyAssetTimeResponse();
        ...
        public static NotifyAssetTimeResponsePacket FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.body = PduRuntime.ConvertObject<NotifyAssetTimeResponse>(bodyValue, item => NotifyAssetTimeResponse.FromDictionary(item));
            }
            return obj;
        }
        ...
        public static NotifyAssetTimeResponsePacket FromJson(string json)
        {
