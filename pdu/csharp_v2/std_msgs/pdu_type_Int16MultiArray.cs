...
namespace Hakoniwa.Pdu.CSharpV2.std_msgs
{
    public class Int16MultiArray
    {
        ...
        public static Int16MultiArray FromDictionary(Dictionary<string, object?> dict)
        {
            ...
            {
                obj.data = PduRuntime.ConvertList<short>(dataValue);
            }
            return obj;
        }
        ...
        public static Int16MultiArray FromJson(string json)
        {
